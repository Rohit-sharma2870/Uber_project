...
function Ridepopup({ setridepopup ,setconfirmride,ride,confirmridedata}) {
  return (
    <div className="flex flex-col bg-white rounded-t-2xl shadow-2xl p-5 max-w-lg mx-auto">
      ...
      <div className="flex items-center justify-between bg-yellow-100 p-3 rounded-xl mb-5">
        <div className="flex items-center gap-4">
          ...
          />
          <div>
            <h4 className="font-semibold text-lg">{ride?.user?.firstname +" "+ ride?.user?.lastname}</h4>
      ...
      <button
        ...
        className="w-full mt-6 py-3 rounded-lg bg-green-500 hover:bg-green-600 transition text-white text-lg font-semibold shadow"
      >
      Accept
      </button>
